...
async function searchSubFiles(imdb) {
    const freLang = axios.get(`https://rest.opensubtitles.org/search/imdbid-${imdb}/sublanguageid-fre`, {headers : {'X-User-Agent': 'TemporaryUserAgent'}});
    const engLang = axios.get(`https://rest.opensubtitles.org/search/imdbid-${imdb}/sublanguageid-eng`, {headers : {'X-User-Agent': 'TemporaryUserAgent'}});
    try {
